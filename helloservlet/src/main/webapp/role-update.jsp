                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="/helloservlet/role-update" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input value="${nameUpdate}" name="newNameUpdate" type="text" id="name" placeholder="Tên quyền"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input value="${descUpdate}" name="newDescUpdate" type="text" id="description" placeholder="Mô tả" class="form-control form-control-line"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
