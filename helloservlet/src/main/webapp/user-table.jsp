		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li><a href="/helloservlet/user" class="waves-effect menu-user"><i
							class="fa fa-user fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Thành viên</span></a></li>
					<li><a href="/helloservlet/role" class="waves-effect menu-role"><i
							class="fa fa-modx fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Quyền</span></a></li>
					<li><a href="/helloservlet/groupwork" class="waves-effect menu-job"><i
							class="fa fa-table fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Dự án</span></a></li>
					<li><a href="/helloservlet/task" class="waves-effect menu-task"><i
							class="fa fa-table fa-fw" aria-hidden="true"></i><span
			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="/helloservlet/user-add" class="btn btn-sm btn-success btn-add">Thêm mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /row -->
										...
										<c:forEach items="${listUser}" var="data">
											<tr>
												...
												<td>
													...
													<a href="/helloservlet/user-delete?id=${data.id}" class="btn btn-sm btn-danger btn-xoa">Xóa</a>
